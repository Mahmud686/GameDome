<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="productdetails.aspx.cs" Inherits="GameDome.View.User.productdetails" %>
        ...
        <div class="col-sm-8"  style="height:500px; ">
          <h1> Name : <asp:Label ID="Label1" runat="server" Text="Product Name"></asp:Label></h1>
           <h2> Date : <asp:Label ID="Label2" runat="server" Text="Price"></asp:Label>    </h2>
            ...
            <h2>Contact:  <asp:Label ID="Label5" runat="server" Text="Posted By:"></asp:Label>    
